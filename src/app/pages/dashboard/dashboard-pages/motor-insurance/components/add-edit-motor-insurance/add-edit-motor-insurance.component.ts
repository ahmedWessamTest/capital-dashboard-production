...
@Component({
  selector: 'app-add-edit-motor-insurances',
  standalone: true,
  ...
  templateUrl: './add-edit-motor-insurance.component.html',
  styleUrl: './add-edit-motor-insurance.component.scss',
})
export class AddEditMotorInsuranceComponent {
