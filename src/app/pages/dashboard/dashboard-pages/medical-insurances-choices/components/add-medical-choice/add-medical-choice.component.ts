...
@Component({
  selector: 'app-add-medical-choice',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './add-medical-choice.component.html',
  styleUrls: ['./add-medical-choice.component.scss'],
  providers: [MessageService]
})
export class AddMedicalChoiceComponent implements OnInit {
  ...
  medicalInsuranceOptions: { label: string; value: number }[] = [];
