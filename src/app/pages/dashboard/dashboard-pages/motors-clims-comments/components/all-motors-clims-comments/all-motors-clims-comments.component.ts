...
@Component({
  ...
  templateUrl: './all-motors-clims-comments.component.html',
  styleUrl: './all-motors-clims-comments.component.scss',
  providers: [MessageService],
})
export class AllMotorClaimsCommentsComponent implements OnInit, OnDestroy {
  private route = inject(ActivatedRoute);
  private claimsService = inject(MotorClaimsService);
  ...
  sendComment() {
    ...
    this.claimsService
      .createComment(this.claimId, commentData, this.selectedFile)
      .subscribe({
        next: (response) => {
