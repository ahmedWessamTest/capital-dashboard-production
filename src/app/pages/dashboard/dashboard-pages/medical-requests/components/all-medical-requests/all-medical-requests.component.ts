...
import { MedicalRequest, MedicalRequestsService } from '../../services/medical-requests.service';
...
@Component({
  selector: 'app-all-medical-requests',
  standalone: true,
  imports: [
    ButtonModule,
    DropdownModule,
  ...
  templateUrl: './all-medical-requests.component.html',
  styleUrl: './all-medical-requests.component.scss',
  providers: [MessageService]
})
export class AllMedicalRequestsComponent {
  private ngxSpinnerService = inject(NgxSpinnerService);
  private messageService = inject(MessageService);
  private medicalRequestsService = inject(MedicalRequestsService);
