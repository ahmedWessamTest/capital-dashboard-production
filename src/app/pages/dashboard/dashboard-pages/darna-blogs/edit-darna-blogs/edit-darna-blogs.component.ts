...
import { BlogsService, BlogResponse, BlogFormData } from '../darna-blogs.service';
...
@Component({
  ...
  templateUrl: './edit-darna-blogs.component.html',
  styleUrl: './edit-darna-blogs.component.scss',
  providers: []
})
export class EditBlogComponent implements OnInit {
    ...
    this.route.data.subscribe({
      next: (data: any) => {
        ...
        this.blogForm.patchValue({
          ...
          en_alt_image: blog.en_alt_image,
          ar_alt_image: blog.ar_alt_image,
          en_slug: blog.en_slug,
          ar_slug: blog.ar_slug,
  ...
  onSubmit() {
    ...
    const apiCall = this.isEditMode && this.blogId
      ? this.blogsService.update(+this.blogId, formData)
      : this.blogsService.create(formData);
