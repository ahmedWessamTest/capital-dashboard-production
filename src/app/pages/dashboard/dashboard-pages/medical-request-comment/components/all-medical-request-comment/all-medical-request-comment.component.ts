...
// import { MedicalRequestCommentsService, MedicalRequestComment, CreateCommentRequest } from '../../services/medical-request-comment.service';
// import { IMAGE_BASE_URL } from '../../../../../../core/constants/WEB_SITE_BASE_UTL';
// import { MedicalRequestResponse } from '../../../medical-requests/services/medical-requests.service';
// import { AuthService } from '../../../../../../auth/services/auth.service';

// @Component({
//   selector: 'app-medical-request-comments',
//   standalone: true,
//   imports: [
//     CommonModule,
//     FormsModule,
...
//   ],
//   templateUrl: './all-medical-request-comment.component.html',
//   styleUrl: './all-medical-request-comment.component.scss',
//   providers: [MessageService]
// })
// export class AllMedicalRequestCommentComponent implements OnInit ,OnDestroy {
//   private route = inject(ActivatedRoute);
//   private commentsService = inject(MedicalRequestCommentsService);
//   private messageService = inject(MessageService);
//   private spinnerService = inject(NgxSpinnerService);
//   private authService = inject(AuthService);
//   comments: MedicalRequestComment[] = [];
//   newComment: string = '';
...
//   currentUserName: string = 'Admin User'; // Replace with actual user name
//   requestId: number = 0;
//   IMAGE_BASE_URL = IMAGE_BASE_URL;
//   requestData!:MedicalRequestResponse;
...
//       reciver_role: this.requestData.data.user?.role || 'user role',
//       reciver_name: this.requestData.data.user?.name || 'reciver name',
